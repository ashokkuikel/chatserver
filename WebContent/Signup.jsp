   ...
   %>
    ...
    ================================================= -->
        ...
        <div class="sign-up-form">
					<a href="index-2.html" class="logo"><img src="images/logo.png" alt="Friend Finder"/></a>
					<h2 class="text-white">Stay connected securely with your friends</h2>
					...
					<div class="form-wrapper">
						...
						<form action="registration.jsp" method="post">
							...
							<fieldset class="form-group">
								<input type="password" class="form-control" name="regpasswd" placeholder="Enter a password">
							</fieldset>
						
 								
							<p>By signing up you agree to the terms</p>
						<button class="btn-secondary" type="submit" value="reg">Signup</button>
						</form>
    ...
    ================================================= -->
		<section id="app-download">
			<div class="container wrapper">
				<!-- <h1 class="section-title slideDown">Secure Messaging</h1> -->
      ...
      <div class="container">
          ...
          <div class="footer-wrapper">
            <div class="col-md-3 col-sm-3">
              <a href="#"><img src="images/logomain.png" alt="" class="footer-logo" /></a>
            ...
            <div class="col-md-3 col-sm-3">
              <h6>Contact Us</h6>
                <ul class="contact">
                	<li><i class="icon ion-ios-telephone-outline"></i>+9841 9841 98</li>
                	<li><i class="icon ion-ios-email-outline"></i>info@securemessaging.com</li>
    ...
    <div w3-include-html="inc/copyright.html">
      <div class="copyright">
